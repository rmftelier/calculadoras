...
function somar() {
  ...
  document.querySelectorAll('.resultado')[0].innerHTML = 'Resultado: ' + resultado;
}
...
function subtrair() {
  ...
  document.querySelectorAll('.resultado')[1].innerHTML = 'Resultado: ' + resultado;
...
function multiplicar() {
  ...
  document.querySelectorAll('.resultado')[2].innerHTML = 'Resultado: ' + resultado;
}
...
function dividir() {
  ...
  if (valor2 === 0) {
    document.querySelectorAll('.resultado')[3].innerHTML = 'Resultado: ' + 'A divisão por zero é inválida';
    return;
  }

  let resultado = valor1 / valor2;

  document.querySelectorAll('.resultado')[3].innerHTML = 'Resultado: ' + resultado;
